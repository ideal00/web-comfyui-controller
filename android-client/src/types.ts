...
export interface ChatMessage {
  ...
  /** Safe model IDs used for this request; never contains API credentials. */
  providerModel?: string
  providerModelsUsed?: string[]
  inputTokens?: number
  outputTokens?: number
...
export interface GameAiSettings {
  ...
  /** Disabled by default; fallback is attempted only after temporary-error retries are exhausted. */
  enableFallbackModels?: boolean
  /** Ordered model IDs to try for temporary 429/5xx failures. */
