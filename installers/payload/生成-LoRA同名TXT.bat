...
if not exist "%PANEL_ROOT%lora_txt_generator.py" (
  echo [ERROR] lora_txt_generator.py is missing. Reinstall LoRA Tools.
  pause
  exit /b 1
)
...
cd /d "%PANEL_ROOT%"
"%PYTHON%" -s "%PANEL_ROOT%lora_txt_generator.py" %*
